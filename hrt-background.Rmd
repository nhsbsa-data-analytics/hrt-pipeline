...
The menopause is a key area of the first government-led womens health strategy for England, created to tackle the gender health gap. This publication has been released to support the work being undertaken by the UK Menopause Taskforce, the NHS Menopause Pathway Improvement Programme, and to help address HRT supply chain issues and shortages

The UK Menopause Taskforce will tackle issues surrounding the menopause including increasing access to treatment, and will try to end the taboos and stigmas that still surround conversations about the menopause, including in the workplace.
...
An overview of the symptoms and treatment of these symptoms can be found on the [NHS website](https://www.nhs.uk/conditions/menopause/).

Information around the Women’s Health Strategy for England is also available online [here](https://www.gov.uk/government/publications/womens-health-strategy-for-england).
