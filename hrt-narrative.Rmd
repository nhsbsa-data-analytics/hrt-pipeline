...
There have been concerns that some women across the UK were unable to obtain their prescriptions due to shortages of HRT products. This coupled with the impact of COVID-related global supply problems means that many women are extremely concerned about not being able to get access to this vital medication. Action has been taken and has been successful, albeit not immediate, in addressing these shortages.

The Department of Health and Social Care (DHSC) has worked closely with suppliers and other stakeholders, to maintain overall HRT supply to patients across the UK. This has included holding roundtables with suppliers, wholesalers, and community pharmacists to discuss the challenges they are facing and what needs to be done to address them in the short- and longer-term; working with suppliers to expedite resupply dates of the disrupted HRT products to resolve issues as soon as possible and to help fill supply gaps and prevent future shortages; and working closely with the NHS Business Service Authority to secure access to HRT dispensing data in order to improve understanding of supply, demand and what is driving shortages and Serious Shortage Protocols (SSPs) have been issued for some HRT medicines.

While the supply of HRT is improving, there is still some way to go. The Government will continue to build on the improvements in the HRT supply position tenure, including through taking forward the HRT Supply Taskforce recommendations, which the Department will ensure are implemented in full.  
