...
This publication shows the volumes of prescription items and unique patients for a subset of drugs that are covered by the HRT Prescription Prepayment Certificate (PPC). The HRT PPC exempts patients from charges at the point of dispensing for drugs licensed to treat menopause in the UK. It should be noted that patients with an HRT PPC are not receiving NHS prescribing free of charge, but are paying for a certificate to help with health costs rather than paying for prescriptions at the point of dispensing. You can find the most up to date list of drugs included in the HRT PPC in [Medicines covered by the HRT PPC.](https://www.nhsbsa.nhs.uk/help-nhs-prescription-costs/nhs-hormone-replacement-therapy-prescription-prepayment-certificate-hrt-ppc/medicines-covered-hrt-ppc)
...
Prescriptions can be issued as either a paper form or as an electronic message using the Electronic Prescription Service (EPS). EPS prescriptions make up most of prescribing and dispensing activity carried out in England, accounting for 89% of all prescriptions dispensed in England during 2023/2024 (Source – NHSBSA Enterprise Data Warehouse). EPS messages are submitted by the dispensing contractor once the prescription has been fulfilled and issued to the patient. The message is initially sent to the [NHS Spine](https://digital.nhs.uk/services/spine), maintained by NHS Digital, and then sent to the NHSBSA for processing. 
...
if a patient moves postcode between releases to an LSOA in a different IMD quintile if the postcode of the prescribing practice is being used and the practice moves postcode between releases to an LSOA in a different IMD quintile if the NSPL is updated and a postcode is recorded against a different area in the new NSPL edition, then the IMD quintile for the new area is used.

<!-- LSOA is only captured for prescriptions via EPS. For those patients who received both paper prescribing and EPS we have imputed their LSOA from the latest available data. As EPS increased considerably from 2020/21 onwards, historical data has much higher rates of patients with a LSOA which was reported as 'Unknown'. -->
...
The Integrated Care Board (ICB) level population figures have been calculated by joining the [ONS mid-2022 population estimates for health geographies in England](https://www.ons.gov.uk/peoplepopulationandcommunity/populationandmigration/populationestimates/datasets/clinicalcommissioninggroupmidyearpopulationestimates) to our data to obtain the estimated population of each ICB. 

The Index of Multiple Deprivation (IMD) quintile level population figures have been taken from [ONS mid-2020 population estimates by age and IMD quintiles in England](https://www.ons.gov.uk/peoplepopulationandcommunity/birthsdeathsandmarriages/deaths/adhocs/1324deathregistrationsandpopulationsbysexageandimdquintileenglandandwales2001to2020). These figures have been aggregated up to the population by all ages and genders by IMD quintile for 2020, as well as the population by 5-year ageband by IMD quintile. Population estimates data at IMD level is not routinely produced by ONS and so the latest available data is for mid-year 2020. The population figures used for each financial year in the summary tables are therefore based on the mid-2020 population only.

These data sources are used to calculate the number of patients per 1,000 of the population. The estimated number of patients per financial year is divided by the ONS population of the region or IMD quintile, and then multiplied by 1000. 
...
#### 2.4.1 Charge status {.toc-ignore}

The charge status categories included in this publication are:
...
Exemption category data for most exemptions is not included in these statistics due to a number of known data quality issues. More information on exemption category data can be found in section 2.4 of this document. NHSBSA performs no validation or verification of which exemption category has been marked or recorded during scanning.
...
An [interactive HRT report](https://nhsbsa-data-analytics.shinyapps.io/hrt-inequalities/) has also been published on the NHSBSA website to provide insights into HRT prescribing in menopause to women aged 40 years and over. Insights are provided by age, deprivation, region, Integrated Care System (ICS), Primary Care Network (PCN), Local Authority, Electoral Ward and Core20 levels. The report also includes specific medication level analyses. The data and findings in the interactive HRT report should not be compared to the HRT England April 2015 to June 2024 statistics publication due to differences in methodology.
...
These principles guide us and are complimented by the UKSA’s regulatory standard for the Quality Assurance of Administrative Data (QAAD). You can download our QAAD assessment of prescription data from the final section on this page of [our webite](https://www.nhsbsa.nhs.uk/statistical-collections).
...
Timeliness refers to the time gap between publication and the reference period. Punctuality refers to the gap between planned and actual publication date.

The Hormone Replacement Therapy publication is an official statistic in development. The date of release for the publication will be announced in advance in line with our statistical release calendar. The publication uses year-to-date figures for the 2024/25 financial year. This allows the inclusion of the most recent data available and reduces lag between the time the data is available and the publication date.
...
We have made a judgement about the suitability of the administrative data for use in producing this publication, this is designed to be pragmatic and proportionate. You can download our QAAD assessment of prescription data from the final section on this page of [our webite](https://www.nhsbsa.nhs.uk/statistical-collections).
